...
class Instance(DataClassJsonMixin):
    ...
    # Assuming the `Instance` class and necessary imports are already defined
    ...
    def from_file(instance_file: str) -> 'Instance':
        with open(instance_file) as f:
            ...
            return instance
# Define the path to your instance JSON file
instance_file_path = '/Users/Win10/Documents/GitHub/AI-and-problem-solving-/instance.json'

# Load the Instance from the JSON file using the static method
instance = Instance.from_file(instance_file_path)

# Access or print the loaded instance to confirm it's working
print(instance)